const ACTIVITY_CATALOG = [
  {
    title: "Desert Safari",
    category: "Adventure",
    image: "https://images.unsplash.com/photo-1788714300675-543545418003?w=800&q=80",
  ...
  },
  {
    ...
    category: "Adventure",
    image: "https://images.unsplash.com/photo-1519021228607-ef6e4c22d821?w=800&q=80",
  ...
  },
  {
    ...
    category: "Adventure",
    image: "https://images.unsplash.com/photo-1709620220232-12ecd7ca33a8?w=800&q=80",
  ...
  },
  {
    ...
    category: "Adventure",
    image: "https://images.unsplash.com/photo-1769450290445-3daed0c8fe63?w=800&q=80",
  ...
  },
  {
    ...
    category: "Adventure",
    image: "https://images.unsplash.com/photo-1568518988484-a4cd9667bd80?w=800&q=80",
  ...
  },
  {
    ...
    category: "Culture",
    image: "https://images.unsplash.com/photo-1757955431527-23c8d9b03359?w=800&q=80",
  ...
  },
  {
    ...
    category: "Culture",
    image: "https://images.unsplash.com/photo-1758980857258-e3323148e194?w=800&q=80",
    tags: ["Live guide", "Small group", "Photo stop"],
    durations: [120, 150, 180],
  },
  {
    ...
    category: "Culture",
    image: "https://images.unsplash.com/photo-1601913463731-cfba9fd31ed3?w=800&q=80",
  ...
  },
  {
    ...
    category: "Food",
    image: "https://images.unsplash.com/photo-1758369908837-38166bca7e1e?w=800&q=80",
  ...
  },
  {
    ...
    category: "Food",
    image: "https://images.unsplash.com/photo-1642874840401-49d3f8095584?w=800&q=80",
  ...
  },
  {
    ...
    category: "Nightlife",
    image: "https://images.unsplash.com/photo-1616658589225-aa7e64e59c13?w=800&q=80",
  ...
  },
  {
    ...
    category: "Nightlife",
    image: "https://images.unsplash.com/photo-1674606867042-2aa3581c1bb5?w=800&q=80",
  ...
  },
  {
    ...
    category: "Water",
    image: "https://images.unsplash.com/photo-1664922114319-4700c0ef74b1?w=800&q=80",
  ...
  },
  {
    ...
    category: "Water",
    image: "https://images.unsplash.com/photo-1688219039942-5f4bc1462664?w=800&q=80",
...
function generateActivity(rng, { city, index, legIndex = 0, template }) {
  ...
  const tags = pickUnique(rng, entry.tags, 1 + Math.floor(rng() * Math.min(3, entry.tags.length)));
...
export function generateActivities({ city, count = 24, seed, legIndex = 0 } = {}) {
...
export async function searchActivities({ city, legIndex = 0, limit = 24 } = {}) {
